    ...
    public partial class UpdateOrderItems : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "6Na5niFGCaUfZz7y9cjbFEq8twj1", false, new DateTime(2025, 3, 8, 20, 53, 21, 215, DateTimeKind.Utc).AddTicks(5930), 1 },
                    { 2, "6Na5niFGCaUfZz7y9cjbFEq8twj1", true, new DateTime(2025, 2, 26, 20, 53, 21, 215, DateTimeKind.Utc).AddTicks(5930), 2 },
                    { 3, "6Na5niFGCaUfZz7y9cjbFEq8twj1", true, new DateTime(2025, 2, 16, 20, 53, 21, 215, DateTimeKind.Utc).AddTicks(5940), 3 },
                    { 4, "l4XlJweAr3USaFL4DW3h2PfIqAC3", false, new DateTime(2025, 3, 8, 20, 53, 21, 215, DateTimeKind.Utc).AddTicks(5940), 4 },
                    { 5, "l4XlJweAr3USaFL4DW3h2PfIqAC3", true, new DateTime(2025, 3, 3, 20, 53, 21, 215, DateTimeKind.Utc).AddTicks(5940), 5 },
                    { 6, "l4XlJweAr3USaFL4DW3h2PfIqAC3", true, new DateTime(2025, 2, 21, 20, 53, 21, 215, DateTimeKind.Utc).AddTicks(5940), 6 }
                });
